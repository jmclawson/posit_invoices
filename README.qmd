...
The `expand_invoices()` function adjusts a simple CSV file to aid with invoicing at the final Friday of each period---either biweekly or monthly. It produces a data frame in the following format:
...
The `set_table()` function prepares a formatted table for invoicing a given period of work.
