...
Use `expand_invoices()` to aid with invoicing at the final Friday of each period---either biweekly or monthly. It produces a data frame in the following format:
